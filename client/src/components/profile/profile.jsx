...
const Profile = () => {
  ...
  const [bio, setBio] = useState(
    "I am a passionate software engineer with a love for developing innovative programs. I enjoy working on challenging projects and collaborating with others."
  );
