...
export const Landnavbar = () => {
  ...
  return (
    <header
      className="fixed inset-0 relative w-full h-screen bg-fixed bg-cover bg-center z-negative h-[1100px]"
      style={{
      ...
      <nav className="flex items-center justify-between px-6 py-4">
        ...
        <div className="flex space-x-4">
          <button
            ...
            className="px-6 py-3 text-lg font-semibold text-white bg-[#1F3839] rounded-full hover:bg-[#1A202C] focus:outline-none focus:ring-2 focus:ring-[#1F2839]"
          >
            Login
          </button>
          <button
            onClick={handleSignupClick}
            className="px-6 py-3 text-lg font-semibold text-gray-900 bg-white border border-gray-900 rounded-full hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-gray-300"
          >
            Signup
          </button>
        </div>
      ...
      <div className="w-full bg-[#F5F5EF]  py-24">
        <div className="max-w-[1000px] m-auto grid grid-cols-3">
          <div className="flex flex-col justify-start gap-4">
            <h1 className="py-4 md:text-5xl text-5xl font-semibold p-4 text-white bg-[#1F2839] rounded-3xl text center mx-auto w-max">
              Testimonials
            </h1>
          </div>
          <div className="flex flex-col items-center">
            <img src={neeti_pfp} alt="neeti pfp" className="mb-4" />
            <p className="p-4 text-2xl text-[#1F2839] text-balance">
              I learned so much from my mentor! - Mentee 2024
            </p>
          </div>
          <div className="flex flex-col items-center">
            <img src={lerich_pfp} alt="lerich pfp" className="mb-4" />
            <p className="p-4 text-2xl text-[#1F2839] text-center ">
              I feel so fulfilled giving advice to my mentee! - Mentor 2023
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="w-full bg-[#D6C7B1]  py-12 h-[350px]">
        <div className="max-w-[1000px] m-auto grid grid-cols-3">
          <div className="flex flex-col items-left">
            <p className="p-2 text-4xl text-[#1F2839] font-semibold">
              Our Team
            </p>
            <p className="p-2 text-2xl text-[#1F2839] text-opacity-55">
              Lerich Osay
            </p>
            <p className="p-2 text-2xl text-[#1F2839] text-opacity-55">
              Neeti Ingle
          ...
          <div className="flex flex-col items-left">
            <p className="p-4 text-4xl text-[#1F2839] font-semibold">
              Directories
            </p>
            <p className="p-4 text-2xl text-[#1F2839] text-opacity-55">Login</p>
            <p className="p-4 text-2xl text-[#1F2839] text-opacity-55">
              Signup
            </p>
            <p className="p-4 text-2xl text-[#1F2839] text-opacity-55">
              About Us
